...
# Form implementation generated from reading ui file 'ui/add_edit.ui'
#
...
"selection-color:rgba(21, 22, 26, 255);")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frame_choice.sizePolicy().hasHeightForWidth())
        self.frame_choice.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.comboBox_addEdit.sizePolicy().hasHeightForWidth())
        self.comboBox_addEdit.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Monotype Corsiva")
        font.setPointSize(15)
        font.setBold(False)
...
"selection-color:rgba(21, 22, 26, 255);")
        ...
        self.verticalLayout_2.addWidget(self.frame_choice)
...
"}")
    ...
    def retranslateUi(self, AddEdit):
        ...
        self.label_clanName.setText(_translate("AddEdit", "<html><head/><body><p>Прізвище роду <span style=\" color:#fb4938;\">*</span></p></body></html>"))
        self.lineEdit_clanName.setPlaceholderText(_translate("AddEdit", "В род. відм. множини"))
        self.label_placeOfBirth.setText(_translate("AddEdit", "Місце народження"))
        self.lineEdit_placeOfBirth.setPlaceholderText(_translate("AddEdit", "Населений пункт"))
        self.label_placeOfDeath.setText(_translate("AddEdit", "Місце смерті"))
        self.lineEdit_placeOfDeath.setPlaceholderText(_translate("AddEdit", "Населений пункт"))
