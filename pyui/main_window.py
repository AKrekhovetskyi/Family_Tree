...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/icons/family_tree.ico"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/icons/Avatar.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        self.pushButton_myCard.setIcon(icon1)
        self.pushButton_myCard.setIconSize(QtCore.QSize(55, 55))
        self.pushButton_myCard.setObjectName("pushButton_myCard")
        self.verticalLayout.addWidget(self.pushButton_myCard)
        self.pushButton_addRemoveClan = QtWidgets.QPushButton(self.verticalGroupBox)
        font = QtGui.QFont()
        ...
        self.pushButton_addRemoveClan.setStyleSheet(
            ...
            "    float: right;\n"
            "    padding: 5px;\n"
            "    border-bottom: 2px solid rgb(38, 127, 51);\n"
            "}\n"
            "\n"
            "QPushButton:pressed {\n"
            "    background-color: rgb(0, 136, 86);\n"
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap(":/icons/Select.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        self.pushButton_addRemoveClan.setIcon(icon2)
        self.pushButton_addRemoveClan.setIconSize(QtCore.QSize(40, 40))
        self.pushButton_addRemoveClan.setObjectName("pushButton_addRemoveClan")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap(":/icons/Edit.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        self.pushButton_addEdit.setIcon(icon3)
        self.pushButton_addEdit.setIconSize(QtCore.QSize(40, 40))
        self.pushButton_addEdit.setObjectName("pushButton_addEdit")
        self.verticalLayout.addWidget(self.pushButton_addEdit)
        self.pushButton_familyTies = QtWidgets.QPushButton(self.verticalGroupBox)
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
        font.setPointSize(10)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap(":/icons/Family.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        self.pushButton_familyTies.setIcon(icon4)
        self.pushButton_familyTies.setIconSize(QtCore.QSize(40, 40))
        self.pushButton_familyTies.setObjectName("pushButton_familyTies")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(
            QtGui.QPixmap(":/icons/Review.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        self.pushButton_review.setIcon(icon5)
        self.pushButton_review.setIconSize(QtCore.QSize(40, 40))
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(
            QtGui.QPixmap(":/icons/Generate.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        self.label_logo.setPixmap(QtGui.QPixmap(":/photos/family_tree.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_addRemoveClan.setText(_translate("MainWindow", "Родини"))
        self.pushButton_addEdit.setText(_translate("MainWindow", "Додати/змінити "))
        self.pushButton_familyTies.setText(_translate("MainWindow", "Сімейні зв'язки"))
        self.pushButton_review.setText(_translate("MainWindow", "Переглянути "))
